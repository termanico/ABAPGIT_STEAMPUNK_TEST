"#autoformat
CLASS zcl_generate_travel_data_184 DEFINITION
 PUBLIC
 FINAL
 CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_184 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:itab TYPE TABLE OF ztravel_184.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_184.

*   insert the new table entries
    INSERT ztravel_184 FROM TABLE @itab.

*   check the result
    SELECT * FROM ztravel_184 INTO TABLE @itab.
    out->write( sy-dbcnt ).
