...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_184.
...
**********************************************************************
  METHOD validate_customer.
    ...
    READ ENTITY zi_travel_m_184\\travel FROM VALUE #(
...
********************************************************************************
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF zi_travel_m_184 IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_184 IN LOCAL MODE
         ENTITY travel
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_184 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
